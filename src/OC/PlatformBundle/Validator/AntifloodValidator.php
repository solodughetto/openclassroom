...
class AntifloodValidator extends ConstraintValidator
{
    ...
    // Les arguments déclarés dans le définition du service arrivent au constructeur
    // On doit les enregistrer dans l'object pour pouvoir s'en resservir dans la méthode validate()
...
//
//        if ($isFlood) {
//            // C'est cette ligne qui déclenche l'erreur pour le formulaire, avec un argument le message
